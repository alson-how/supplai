...
This repository establishes the runnable vertical slice: enterprise dashboard, secured API, approval/audit workflow, full tenant-oriented persistence model, and a real constrained optimiser with diagnostics. Phase 2 adds tenant-scoped product CRUD plus market, customer, inventory, production, and logistics query/calculation modules over a reproducible 25-customer operational dataset. Remaining increments include database-backed repositories and migrations, imports, forecast endpoints, the full scenario UI, Express Swagger integration, and Playwright coverage.
